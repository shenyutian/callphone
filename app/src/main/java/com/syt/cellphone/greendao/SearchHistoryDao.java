...
public class SearchHistoryDao extends AbstractDao<SearchHistory, Long> {
    ...
    public static class Properties {
        ...
        public final static Property SearchLocal = new Property(2, Long.class, "searchLocal", false, "SEARCH_LOCAL");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SEARCH_HISTORY\" (" + //
                ...
                "\"SEARCH_CONTENT\" TEXT UNIQUE ," + // 1: searchContent
                "\"SEARCH_LOCAL\" INTEGER);"); // 2: searchLocal
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, SearchHistory entity) {
        ...
        Long searchLocal = entity.getSearchLocal();
        if (searchLocal != null) {
            stmt.bindLong(3, searchLocal);
        }
    }
    ...
    public SearchHistory readEntity(Cursor cursor, int offset) {
        SearchHistory entity = new SearchHistory( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2) // searchLocal
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SearchHistory entity, int offset) {
        ...
        entity.setSearchLocal(cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2));
     }
