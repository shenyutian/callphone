 ...
 * 功能 品牌列表适配器
 */
public class BrandAdapter extends BaseQuickAdapter<PhoneTrademark, BaseViewHolder> {
    ...
    protected void convert(@NonNull BaseViewHolder helper, PhoneTrademark item) {
        Glide.with(mContext).load(item.getTrademarkLog()).into((ImageView) helper.getView(R.id.iv_brand_picture));
